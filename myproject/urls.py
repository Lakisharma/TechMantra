...
urlpatterns = [
    ...
    path('forgot_password', views.forgot_password_view),
    path('reset-password/', views.forgot_password_view),
    path('reset-password', views.forgot_password_view),
    ...
    path('admin-dashboard/students/export-excel/', views.admin_export_students_excel, name='admin_export_students_excel'),
    path('admin-dashboard/admissions/export-excel/', views.admin_export_admissions_excel, name='admin_export_admissions_excel'),
